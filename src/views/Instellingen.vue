    ...
    <div v-if="activeTab === 'integraties'" class="space-y-4">
      <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <div v-else class="space-y-4">
          ...
          <!-- Sensoren & Kamers link -->
          <router-link
            to="/woning"
            class="flex items-center gap-3 p-4 bg-primary-50 border border-primary-100 rounded-xl hover:bg-primary-100 transition-colors"
          >
            ...
            <span class="text-sm font-medium text-primary-700">Sensoren &amp; Kamers bekijken →</span>
          </router-link>
